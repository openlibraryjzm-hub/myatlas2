...
- **Seamless Morphing Overlay Viewer**: Right-clicking or clicking any card opens the Seamless Morphing Overlay Viewer ([`viewer_overlay.md`](file:///c:/Users/jodyn/Desktop/my%20atlas%202/docs/views/viewer_overlay.md)), providing 3 dedicated modes (`Media`, `Tags`, `Edit`) while keeping the Browse Grid 100% mounted in the background.
